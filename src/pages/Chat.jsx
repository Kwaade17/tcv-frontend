        ...
        <>
          <div className="mt-6">
            ...
            <div className="w-65 h-auto text-center rounded-lg border border-dashed border-slate-400 mx-auto mt-2 space-y-1.5 overflow-hidden">
              ...
              <p className="w-full h-full bg-slate-300 py-4 text-sm font-light">Chat With Us page is currently under development.<br /><br /><span className="text-xs font-thin"><em>Please go back!</em></span></p>
            </div>
          </div>
